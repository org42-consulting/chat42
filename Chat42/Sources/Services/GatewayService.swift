...
enum GatewayError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .unreachable(let url):       return String(format: String(localized: "error.gateway.unreachable"), url)
        case .authenticationFailed:       return String(localized: "error.gateway.auth_failed")
        case .invalidResponse(let code):  return String(format: String(localized: "error.gateway.invalid_response"), code)
        case .apiError(let msg):          return String(format: String(localized: "error.gateway.api_error"), msg)
